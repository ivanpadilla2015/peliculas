  ...
  <div class="flex flex-wrap -mx-3 mb-6">
    ...
    <div class="flex flex-wrap -mx-3 mb-6">
      <div class="w-full px-3">
        ...
        <textarea name="descripcion" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-1 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" placeholder="descripcion"  rows="3"></textarea>
    ...
    <div class="flex flex-wrap -mx-3 mb-2"> <!-- 2 Campos -->
      <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
        ...
        <input name="serial" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-zip" type="text" placeholder="Serial">
      ...
      <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
        ...
        <!-- <?php // echo date("Y-m-d");?>-->
        <input name="fe_adquisicion"  class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-7 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"  type="date" placeholder="fecha">
      ...
      <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
        ...
        <input name="sap" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"  type="text" placeholder="sap">
    ...
    <div class="flex flex-wrap -mx-3 mb-6">
      <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
        ...
        <input name="nompc" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="nompc" type="text" placeholder="Nombre Pc">
