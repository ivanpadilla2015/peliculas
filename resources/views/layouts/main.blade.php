            ...
            <ul class="flex flex-col md:flex-row items-center">
                ...
                <li>
                    <div class="dropdown inline-block relative">
                        ...
                        <ul class="dropdown-menu absolute hidden text-gray-700 pt-1">
                          <li class=""><a  class="rounded-t bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" href="/personal">Listado </a></li>
                          <li class=""><a  class="bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" href="/personal/create">Crear</a></li>
                          <li class=""><a  class="bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" href="#">Equipo(s) x Dependencia</a></li>
                          <li class=""><a class="rounded-b bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" href="#">Three is the magic number</a></li>
                        </ul>
                    </div>
