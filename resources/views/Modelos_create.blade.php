<div class="w-full">
    <div class="flex flex-wrap justify-between items-center mb-5">
        <div class="w-auto pr-3">
            ...
            <input class="w-64 block bg-gray-800 text-sm border {{ $errors->has('nombremodelo') ? ' border-red-500' : 'border-gray-200' }} rounded  px-4  py-1 leading-tight focus:outline-none focus:shadow-outline" id="nombremodelo" wire:model="nombremodelo" type="text" placeholder="Nombre Modelo...">
            @error('nombremodelo')
