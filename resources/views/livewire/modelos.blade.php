<div>
    @if($updateMode)
        @include('modelos_update')
    @else
        @include('modelos_create')
    @endif
    ...
    <table class="text-sm table-auto w-full">
        <thead>
            <tr class="bg-gray-700">
                ...
                <th class="border-solid border-2 border-gray-600 text-gray-900 px-4 py-1 ">Nombre Modelo</th>
                <th class="border-solid border-2 border-gray-600 text-gray-900 px-4 py-1 ">Acciones</th>
            </tr>
        </thead>
        <tbody>
            @forelse ($data as $item)
                <tr class="text-center">
                    ...
                    <td class="border-solid border-2 border-gray-600 text-gray-600 px-4 py-1">{{ $item->nombremodelo }}</td>
